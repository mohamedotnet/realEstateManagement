    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${array}" var="agent">
                    <tr>
                        <th scope="row">${agent.id}</th>
                        <td>${agent.name}</td>
                        <td>${agent.lastName}</td>
                        <td>${agent.username}</td>
                        <td><form:form modelAttribute="agent" action="/removeAgentSuccess" method="post">
                            <form:hidden path="id" value="${agent.id}"/>
                            <form:hidden path="name" value="${agent.name}"/>
                            <form:hidden path="lastName" value="${agent.lastName}"/>
                            <form:hidden path="email" value="${agent.email}"/>
                            <form:hidden path="username" value="${agent.username}"/>
                            <form:hidden path="sex" value="${agent.sex}"/>
                            <form:hidden path="phone" value="${agent.phone}"/>
                            <form:hidden path="password" value="${agent.password}"/>
                            <form:hidden path="address" value="${agent.address}"/>
                            <form:hidden path="birthday" value="${agent.birthday}"/>
                            <form:hidden path="idNumber" value="${agent.idNumber}"/>

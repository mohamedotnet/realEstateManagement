...
<body>
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li><a href="${pageContext.request.contextPath}/Admin/editAdmin">Modifier un Admin</a></li>
            <li><a href="${pageContext.request.contextPath}/Admin/editAgent">Modifier un Agent</a></li>
            <li><a href="${pageContext.request.contextPath}/Admin/editCustomer">Modifier un Client</a></li>
            <li><a href="${pageContext.request.contextPath}/Admin/editManager">Modifier un Responsable</a></li>
            <li><a href="${pageContext.request.contextPath}/Admin/editOperator">Modifier un Opérateur</a></li>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <c:forEach items="${array}" var="admin">
                    <tr>
                        <th scope="row">${admin.id}</th>
                        <td>${admin.name}</td>
                        <td>${admin.lastName}</td>
                        <td>${admin.username}</td>
                        <td><form:form modelAttribute="admin" action="/editAdminForm" method="post">
                            <form:hidden path="id" value="${admin.id}"/>
                            <form:hidden path="name" value="${admin.name}"/>
                            <form:hidden path="lastName" value="${admin.lastName}"/>
                            <form:hidden path="email" value="${admin.email}"/>
                            <form:hidden path="username" value="${admin.username}"/>
                            <form:hidden path="sex" value="${admin.sex}"/>
                            <form:hidden path="phone" value="${admin.phone}"/>
                            <form:hidden path="password" value="${admin.password}"/>
                            <form:hidden path="address" value="${admin.address}"/>
                            <form:hidden path="birthday" value="${admin.birthday}"/>
                            <form:hidden path="idNumber" value="${admin.idNumber}"/>

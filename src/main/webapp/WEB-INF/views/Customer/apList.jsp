                        ...
                        <div class="card">
                            <div class="card-body" style="padding: 0;">
                                ...
                                <div class="card-block" style="padding: 1.5rem;">
                                    ...
                                    <form method="get">
                                        <button type="submit" class="btn btn-dark" onclick="form.action='/Customer/fixAppointment'" name = "ref" value="${app.reference}">Fixer un RDV</button>
                                        <button type="submit" class="btn btn-dark ml-4" onclick="form.action='/Customer/sellApartment'" name = "ref" value="${app.reference}">Acheter</button>
                                    </form>
                                </div>
                            </div>
                        </div>

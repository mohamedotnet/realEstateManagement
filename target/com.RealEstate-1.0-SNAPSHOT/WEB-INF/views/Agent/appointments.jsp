            ...
            <table class="table">
                ...
                <c:forEach items="${array}" var="app">
                    <tr>
                        ...
                        <td><form:form modelAttribute="app" action="/validateAppointment" method="post">
                            ...
                            <button type="submit" class="btn btn-primary mb-2">Accepter Rendez-Vous</button>
                            </form:form>
                        </td>
                    </tr>
                </c:forEach>

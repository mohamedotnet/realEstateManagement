    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${array}" var="manager">
                    <tr>
                        <th scope="row">${manager.id}</th>
                        <td>${manager.name}</td>
                        <td>${manager.lastName}</td>
                        <td>${manager.username}</td>
                        <td><form:form modelAttribute="manager" action="/removeManagerSuccess" method="post">
                            <form:hidden path="id" value="${manager.id}"/>
                            <form:hidden path="name" value="${manager.name}"/>
                            <form:hidden path="lastName" value="${manager.lastName}"/>
                            <form:hidden path="email" value="${manager.email}"/>
                            <form:hidden path="username" value="${manager.username}"/>
                            <form:hidden path="sex" value="${manager.sex}"/>
                            <form:hidden path="phone" value="${manager.phone}"/>
                            <form:hidden path="password" value="${manager.password}"/>
                            <form:hidden path="address" value="${manager.address}"/>
                            <form:hidden path="birthday" value="${manager.birthday}"/>
                            <form:hidden path="idNumber" value="${manager.idNumber}"/>

    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="py-5 text-center">
                ...
                <h2>Modifier ${agent.username}</h2>
            </div>

            <div class="row justify-content-center">
                <div class="col-md-6 order-md-1">
                    <form:form modelAttribute="agent" class="needs-validation" method="post" action="/editAgentSuccess">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="firstName">Nom:</label>
                                <input path="id" value="${agent.id}" type="hidden" name="id"/>
